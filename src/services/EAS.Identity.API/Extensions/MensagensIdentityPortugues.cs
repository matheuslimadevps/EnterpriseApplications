...
namespace EAS.Identity.API.Extensions
{
    public class MensagensIdentityPortugues : IdentityErrorDescriber    
    {
        ...
        public override IdentityError PasswordTooShort(int length) { return new IdentityError { Code = nameof(PasswordTooShort), Description = $"As sennhas devem conter ao menos '{length}' caracteres." }; }
